...
public static class LethalConfigNicerizer
{
	...
	public static ConfigEntry<T> Nicerize<T>(ConfigEntry<T> entry, bool restartRequired = false)
	{
	...
	[MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.NoOptimization)]
    public static void AddConfigItem(ConfigEntry<int> entry, bool restartRequired = false)
    {
	...
	[MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.NoOptimization)]
    public static void AddConfigItem(ConfigEntry<float> entry, bool restartRequired = false)
    {
		if(entry.Description.AcceptableValues != null) {
	...
	[MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.NoOptimization)]
    public static void AddConfigItem(ConfigEntry<bool> entry, bool restartRequired = false)
    {
		LethalConfigManager.AddConfigItem(new LethalConfig.ConfigItems.BoolCheckBoxConfigItem(entry, restartRequired));
    }

	[MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.NoOptimization)]
    public static void AddConfigItem(ConfigEntry<string> entry, bool restartRequired = false)
    {
		if(entry.Description.AcceptableValues != null) {
	...
	[MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.NoOptimization)]
    public static void AddConfigItem(ConfigEntry<Enum> entry, bool restartRequired = false)
    {
